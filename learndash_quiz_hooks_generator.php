...
if(!class_exists('LearnDash_Quiz_Hooks_Generator')) {
    ...
    class LearnDash_Quiz_Hooks_Generator {
        ...
        public function __construct() {
            ...
            add_filter("ld_hook_generator_quiz_questions", array($this, 'ld_customize_quiz_questions'));
        }

        /**
         * A Demo function to demonstrate how to customize Quiz question 
         * using a new hook generated by LD Quiz hook generator
         * @return $quiz_data
        */
        public function ld_customize_quiz_questions($quiz_data) {
            foreach($quiz_data as $key => $question) {
                $text = $question->getQuestion();
                $question->setQuestion("Example Question Text modified by Quiz Hook Generaor Plugin <br /> Old version: " . $text);
            }
            return $quiz_data;
        }
